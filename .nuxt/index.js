...
import nuxt_plugin_bootstrapvue_3ca0d609 from 'nuxt_plugin_bootstrapvue_3ca0d609' // Source: ./bootstrap-vue.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Brook","titleTemplate":"Brook || %s","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Creative Multipurpose Vue Nuxt JS Template"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_bootstrapvue_3ca0d609 === 'function') {
    await nuxt_plugin_bootstrapvue_3ca0d609(app.context, inject)
  }
